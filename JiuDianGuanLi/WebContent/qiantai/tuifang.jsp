...
%>
 ...
 <a href="fangjiandel.action?id=<%=f.getId() %>">
   <button type="button" class="layui-btn">删除</button></a>
			...
			<td>
			 <a href="tuifanginfo.jsp?id=<%=f.getFno() %>"><button type="button" class="layui-btn ">查看入住信息</button></a>
			</td>
			<td>
			 <a href="tuifang.action?id=<%=f.getFno() %>"><button type="button" class="layui-btn ">退房</button></a>
			</td>
...
%>
  ...
  <a href="fangjianadd.jsp"><button type="button" class="layui-btn layui-btn-sm layui-btn-normal">添加新的房间信息</button></a>
