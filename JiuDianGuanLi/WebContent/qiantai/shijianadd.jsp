...
<html>
	...
	<body>
		...
		<form action="shijianadd.action" method="post">
		
			<p>
				<span>事件</span>
				<input type="text" name="shijian" id="" value="" />
			</p>
			<p>
				<span>要求</span>
				<input type="text" name="yaoqiu" id="" value="" />
			</p>
			<p>
				<span>备注</span>
...
%>					
			...
			<p>
			<a href="shijianlist1.jsp"><button type="button">返回列表</button></a>
			</p>
		</form>
