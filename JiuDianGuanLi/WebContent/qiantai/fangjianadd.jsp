...
<html>
	...
	<body>
		...
		<form action="fangjianadd.action" method="post">
		
			<p>
				<span>房间编号</span>
				<input type="text" name="fno" id="" value="" />
			</p>
			<p>
				<span>房间状态</span>
				<input type="text" name="zhuangtai" id="" value="" />
			</p>
			<p>
				<span>房间类型</span>
				<input type="text" name="leixing" id="" value="" />
			</p>

			<p>
				<span>房间价格</span>
				<input type="text" name="jiage" id="" value="" />
			</p>
