...
%>	
		<form action="fuwuinfoupd.action" method="post">
		<input type="hidden" name="yid" id="" value="<%=id1 %>" />
		<p>
		<span>员工姓名</span>
		
		<input type="text" name="yname" id="" value="<%=s.getYname() %>" />
		</p>
		<p>
		<span>员工身份证</span>
		
		<input type="text" name="yidc" id="" value="<%=s.getYidc() %>" />
		...
		<input type="text" name="ytel" id="" value="<%=s.getYtel() %>" />
			...
			<p>
				<a href="fuwuinfolist.jsp"><button type="button">返回列表</button></a>
			</p>
		</form>
