...
<html>
	...
	<body>
		...
		<form action="Add1.action" method="post">
			<p>
				<span>前台账号</span>
			...
			<p>
				<span>前台姓名</span>
				<input type="text" name="qname" id="" value="" />
			</p>
			<p>
				<span>前台登陆密码</span>
				<input type="text" name="qdlpass" id="" value="" />
			</p>
			<p>
				<span>前台性别</span>
				<input type="text" name="qsex" id="" value="" />
			</p>
			<p>
				<span>前台年龄</span>
				<input type="text" name="qage" id="" value="" />
			</p>
			
			<p>
				<span>前台身份证号</span>
				<input type="text" name="qidc" id="" value="" />
			</p>
			
			<p>
				<span>前台工资</span>
				<input type="text" name="gongzhi" id="" value="" />
			</p>
