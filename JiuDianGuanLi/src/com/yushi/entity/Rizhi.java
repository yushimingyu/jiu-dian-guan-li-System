...
public class Rizhi {
	...
	public Rizhi(Integer gid, String gname, String gtel, String gidc, Integer ghsno, String gyystate, String gruzhutime,
			String gouttime, String ghstate, String zhifustate, String beizhu, Integer huafei) {
		super();
		this.gid = gid;
		this.gname = gname;
		this.gtel = gtel;
